...
## StudEd Microservice K8s Topology

> Target Kubernetes manifests live in `infra/k8s/`.

| Service | Container Image | Port(s) | Protocol |
|---------|-----------------|---------|----------|
| `api-gateway` | `studed-doc-api-gateway` | 8080 | HTTP (GraphQL / REST) |
| `auth-service` | `studed-doc-auth-service` | 8081, 8085 | HTTP / gRPC |
| `course-service` | `studed-doc-course-service` | 8083, 8084 | HTTP / gRPC |
| `progress-service` | `studed-doc-progress-service` | 8086, 8087 | HTTP / gRPC |
| `gamification-service` | `studed-doc-gamification-service` | 8088, 8089 | HTTP / gRPC |
| `ai-service` | `studed-doc-ai-service` | 8090 | HTTP |
| `payment-service` | `studed-doc-payment-service` | 8091 | HTTP |
| `notification-service` | `studed-doc-notification-service` | 8092 | HTTP |
| `postgres` | `postgres:15-alpine` | 5432 | TCP |
| `redis` | `redis:7-alpine` | 6379 | TCP |
| `elasticsearch` | `studed-doc-elasticsearch` | 9200 | HTTP |
