...
const (
	...
	CourseService_DeleteWave_FullMethodName           = "/course.CourseService/DeleteWave"
)
...
type CourseServiceClient interface {
	...
	DeleteLesson(ctx context.Context, in *DeleteLessonRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
	...
	DeleteWave(ctx context.Context, in *DeleteWaveRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
}
...
func (c *courseServiceClient) DeleteCourse(ctx context.Context, in *DeleteCourseRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *courseServiceClient) DeleteLesson(ctx context.Context, in *DeleteLessonRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteResponse)
...
func (c *courseServiceClient) DeleteWave(ctx context.Context, in *DeleteWaveRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteResponse)
	err := c.cc.Invoke(ctx, CourseService_DeleteWave_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CourseServiceServer interface {
	...
	DeleteLesson(context.Context, *DeleteLessonRequest) (*DeleteResponse, error)
	...
	DeleteWave(context.Context, *DeleteWaveRequest) (*DeleteResponse, error)
...
func (UnimplementedCourseServiceServer) DeleteCourse(context.Context, *DeleteCourseRequest) (*DeleteResponse, error) {
...
func (UnimplementedCourseServiceServer) DeleteLesson(context.Context, *DeleteLessonRequest) (*DeleteResponse, error) {
...
func (UnimplementedCourseServiceServer) DeleteWave(context.Context, *DeleteWaveRequest) (*DeleteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteWave not implemented")
}
...
func _CourseService_DeleteWave_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteWaveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseServiceServer).DeleteWave(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseService_DeleteWave_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseServiceServer).DeleteWave(ctx, req.(*DeleteWaveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CourseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteWave",
			Handler:    _CourseService_DeleteWave_Handler,
		},
	},
