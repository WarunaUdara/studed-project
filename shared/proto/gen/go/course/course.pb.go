...
const file_course_course_proto_rawDesc = "" +
	...
	"\x0fDIFFICULTY_HARD\x10\x032\xec\x06\n" +
	"\rCourseService\x12C\n" +
...
var file_course_course_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_course_course_proto_goTypes = []any{
	...
	(*CourseListResponse)(nil),   // 10: course.CourseListResponse
	(*CreateLessonRequest)(nil),  // 11: course.CreateLessonRequest
	(*GetLessonRequest)(nil),     // 12: course.GetLessonRequest
	(*ListLessonsRequest)(nil),   // 13: course.ListLessonsRequest
	(*PublishLessonRequest)(nil), // 14: course.PublishLessonRequest
	(*LessonResponse)(nil),       // 15: course.LessonResponse
	(*LessonListResponse)(nil),   // 16: course.LessonListResponse
	(*CreateWaveRequest)(nil),    // 17: course.CreateWaveRequest
	(*GetWaveRequest)(nil),       // 18: course.GetWaveRequest
	(*ListWavesRequest)(nil),     // 19: course.ListWavesRequest
	(*UpdateWaveRequest)(nil),    // 20: course.UpdateWaveRequest
	(*PublishWaveRequest)(nil),   // 21: course.PublishWaveRequest
	(*WaveResponse)(nil),         // 22: course.WaveResponse
	(*WaveListResponse)(nil),     // 23: course.WaveListResponse
	(auth.Grade)(0),              // 24: auth.Grade
}
var file_course_course_proto_depIdxs = []int32{
	24, // 0: course.Course.grade_level:type_name -> auth.Grade
	0,  // 1: course.Course.status:type_name -> course.CourseStatus
	1,  // 2: course.Wave.difficulty:type_name -> course.Difficulty
	24, // 3: course.CreateCourseRequest.grade_level:type_name -> auth.Grade
	24, // 4: course.ListCoursesRequest.grade_level:type_name -> auth.Grade
	2,  // 5: course.CourseResponse.course:type_name -> course.Course
	2,  // 6: course.CourseListResponse.courses:type_name -> course.Course
	3,  // 7: course.LessonResponse.lesson:type_name -> course.Lesson
	3,  // 8: course.LessonListResponse.lessons:type_name -> course.Lesson
	1,  // 9: course.CreateWaveRequest.difficulty:type_name -> course.Difficulty
	1,  // 10: course.UpdateWaveRequest.difficulty:type_name -> course.Difficulty
	4,  // 11: course.WaveResponse.wave:type_name -> course.Wave
	4,  // 12: course.WaveListResponse.waves:type_name -> course.Wave
	5,  // 13: course.CourseService.CreateCourse:input_type -> course.CreateCourseRequest
	6,  // 14: course.CourseService.GetCourse:input_type -> course.GetCourseRequest
	7,  // 15: course.CourseService.ListCourses:input_type -> course.ListCoursesRequest
	8,  // 16: course.CourseService.PublishCourse:input_type -> course.PublishCourseRequest
	11, // 17: course.CourseService.CreateLesson:input_type -> course.CreateLessonRequest
	12, // 18: course.CourseService.GetLesson:input_type -> course.GetLessonRequest
	13, // 19: course.CourseService.ListLessons:input_type -> course.ListLessonsRequest
	14, // 20: course.CourseService.PublishLesson:input_type -> course.PublishLessonRequest
	17, // 21: course.CourseService.CreateWave:input_type -> course.CreateWaveRequest
	18, // 22: course.CourseService.GetWave:input_type -> course.GetWaveRequest
	19, // 23: course.CourseService.ListWaves:input_type -> course.ListWavesRequest
	20, // 24: course.CourseService.UpdateWave:input_type -> course.UpdateWaveRequest
	21, // 25: course.CourseService.PublishWave:input_type -> course.PublishWaveRequest
	9,  // 26: course.CourseService.CreateCourse:output_type -> course.CourseResponse
	9,  // 27: course.CourseService.GetCourse:output_type -> course.CourseResponse
	10, // 28: course.CourseService.ListCourses:output_type -> course.CourseListResponse
	9,  // 29: course.CourseService.PublishCourse:output_type -> course.CourseResponse
	15, // 30: course.CourseService.CreateLesson:output_type -> course.LessonResponse
	15, // 31: course.CourseService.GetLesson:output_type -> course.LessonResponse
	16, // 32: course.CourseService.ListLessons:output_type -> course.LessonListResponse
	15, // 33: course.CourseService.PublishLesson:output_type -> course.LessonResponse
	22, // 34: course.CourseService.CreateWave:output_type -> course.WaveResponse
	22, // 35: course.CourseService.GetWave:output_type -> course.WaveResponse
	23, // 36: course.CourseService.ListWaves:output_type -> course.WaveListResponse
	22, // 37: course.CourseService.UpdateWave:output_type -> course.WaveResponse
	22, // 38: course.CourseService.PublishWave:output_type -> course.WaveResponse
