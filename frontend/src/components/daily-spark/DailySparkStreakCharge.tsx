          ...
          >
            <svg viewBox="0 0 200 200" className="size-full">
              ...
              <g transform="translate(100, 100) rotate(-35) translate(-100, -100)">
                {/* Top Cap Terminal */}
                <rect x="88" y="32" width="24" height="10" rx="3" fill="#64748b" />
                {/* Top Main Cap */}
                <rect x="70" y="40" width="60" height="24" rx="8" fill="url(#battery-cap)" />
                ...
                {/* Bottom Main Cap */}
                <rect x="70" y="136" width="60" height="24" rx="8" fill="url(#battery-cap)" />
                {/* Bottom Terminal */}
                <rect x="84" y="158" width="32" height="6" rx="2" fill="#334155" />
              </g>
            </svg>
          </motion.div>
        </div>
