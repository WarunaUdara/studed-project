...
const PointsLevelsTimeline = React.forwardRef<HTMLDivElement, PointsLevelsTimelineProps>(
  (
    { className, levels, currentPoints, currentLevelLabel = "Current", formatPoints, ...props },
    ref,
  ) => {
    ...
    return (
      <div ref={ref} className={cn("bg-card w-full rounded-xl border p-4", className)} {...props}>
                ...
                >
                  ...
                  <div className="min-w-0 space-y-2">
                    <div className="flex flex-wrap items-center gap-2">
                      <h3 className="text-foreground text-lg font-semibold">{level.name}</h3>
                      {isCurrent ? (
                      ...
                      <div className="space-y-1 pt-1">
                        {level.subLevels.map((subLevel, subIndex) => {
                          ...
                          return (
                            ...
                            >
                              <span className="text-foreground font-medium">{subLevel.name}</span>{" "}
